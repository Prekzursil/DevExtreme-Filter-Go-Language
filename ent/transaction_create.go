...
func (tc *TransactionCreate) SetLocation(s string) *TransactionCreate {
...
func (tc *TransactionCreate) check() error {
	...
	if _, ok := tc.mutation.Location(); !ok {
		return &ValidationError{Name: "location", err: errors.New(`ent: missing required field "Transaction.location"`)}
	}
